...
export class SiteDomainsApi {
  ...
  public async sitesSiteIdDomainsDomainAttachPost(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/domains/{domain}/attach'
  ...
  public async sitesSiteIdDomainsDomainDetachPost(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/domains/{domain}/detach'
        .replace('{' + 'site_id' + '}', encodeURIComponent(String(siteId)))
        .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)));
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
  ...
  public async sitesSiteIdDomainsDomainGet(
    ...
    domain: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: DomainGetResponse }> {
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/domains/{domain}'
        .replace('{' + 'site_id' + '}', encodeURIComponent(String(siteId)))
  ...
  public async sitesSiteIdDomainsDomainSelectionDelete(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/domains/{domain}/selection'
        .replace('{' + 'site_id' + '}', encodeURIComponent(String(siteId)))
        .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)));
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
  ...
  public async sitesSiteIdDomainsDomainValidationGet(
    ...
    response: http.IncomingMessage;
    body: DomainValidationGetResponse;
  }> {
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/domains/{domain}/validation'
        .replace('{' + 'site_id' + '}', encodeURIComponent(String(siteId)))
        .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)));
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
  ...
  public async sitesSiteIdDomainsGet(
    ...
    response: http.IncomingMessage;
    body: Array<DomainGetResponse>;
  }> {
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/domains'.replace(
        '{' + 'site_id' + '}',
