...
export class DomainsReplacedToTheSiteDomainsApi {
  ...
  public setApiKey(
    key: DomainsReplacedToTheSiteDomainsApiApiKeys,
    value: string
  ) {
    (this.authentications as any)[
      DomainsReplacedToTheSiteDomainsApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async domainsDomainAttachDomainToShifterCdnPost(
    ...
    const localVarPath =
      this.basePath +
      '/domains/{domain}/attach_domain_to_shifter_cdn'.replace(
        '{' + 'domain' + '}',
  ...
  public async domainsDomainDetachDomainFromShifterCdnPost(
    ...
    const localVarPath =
      this.basePath +
      '/domains/{domain}/detach_domain_from_shifter_cdn'.replace(
        '{' + 'domain' + '}',
        encodeURIComponent(String(domain))
      );
    let localVarQueryParameters: any = {};
  ...
  public async domainsDomainResendValidationEmailPost(
    ...
    const localVarPath =
      this.basePath +
      '/domains/{domain}/resend_validation_email'.replace(
        '{' + 'domain' + '}',
        encodeURIComponent(String(domain))
      );
    let localVarQueryParameters: any = {};
  ...
  public async domainsDomainSelectionPost(
    ...
    const localVarPath =
      this.basePath +
      '/domains/{domain}/selection'.replace(
        '{' + 'domain' + '}',
        encodeURIComponent(String(domain))
      );
    let localVarQueryParameters: any = {};
  ...
  public async domainsDomainValidateOperationDnsPost(
    ...
    const localVarPath =
      this.basePath +
      '/domains/{domain}/validate_operation/dns'.replace(
        '{' + 'domain' + '}',
        encodeURIComponent(String(domain))
      );
    let localVarQueryParameters: any = {};
  ...
  public async domainsDomainValidateOperationDnsValidationGet(
    ...
    const localVarPath =
      this.basePath +
      '/domains/{domain}/validate_operation/dns/validation'.replace(
        '{' + 'domain' + '}',
        encodeURIComponent(String(domain))
      );
    let localVarQueryParameters: any = {};
  ...
  public async domainsDomainValidateOperationEmailPost(
    ...
    const localVarPath =
      this.basePath +
      '/domains/{domain}/validate_operation/email'.replace(
        '{' + 'domain' + '}',
        encodeURIComponent(String(domain))
      );
    let localVarQueryParameters: any = {};
  ...
  public async domainsGet(
    ...
    body: Array<InlineResponse20013>;
  }> {
