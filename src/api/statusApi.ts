...
export class StatusApi {
     ...
     */
    public async statusGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StatusGetResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: StatusGetResponse;  }>((resolve, reject) => {
     ...
     */
    public async statusTeamsTeamIdRoleGet (teamId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2009;  }> {
        const localVarPath = this.basePath + '/status/teams/{team_id}/role'
        ...
        if (teamId === null || teamId === undefined) {
            throw new Error('Required parameter teamId was null or undefined when calling statusTeamsTeamIdRoleGet.');
        }
