...
export class RolesApi {
  ...
  ): Promise<{ response: http.IncomingMessage; body: Array<RoleGetResponse> }> {
  ...
  public async rolesNameGet(
    name: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: RoleGetResponse }> {
    const localVarPath =
      this.basePath +
      '/roles/{name}'.replace(
        '{' + 'name' + '}',
