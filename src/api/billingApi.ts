...
export class BillingApi {
  ...
  public async billingsPlansGet(
    ...
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: Array<PlanGetResponse> }> {
  ...
  public async billingsSubscriptionsGet(
    ...
    response: http.IncomingMessage;
    body: Array<SubscriptionGetResponse>;
  }> {
  ...
  public async billingsSubscriptionsPost(
    ...
    response: http.IncomingMessage;
    body: SubscriptionCreateResponse;
  }> {
    const localVarPath = this.basePath + '/billings/subscriptions';
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
  ...
  public async billingsSubscriptionsSubscriptionIdDelete(
    ...
    const localVarPath =
      this.basePath +
      '/billings/subscriptions/{subscription_id}'.replace(
        '{' + 'subscription_id' + '}',
  ...
  public async billingsSubscriptionsSubscriptionIdPost(
    ...
    response: http.IncomingMessage;
    body: SubscriptionUpdateResponse;
  }> {
    const localVarPath =
      this.basePath +
      '/billings/subscriptions/{subscription_id}'.replace(
