...
export class TeamsApi {
  ...
  public async teamsMembersMemberNameTeamsGet(
    ...
    const localVarPath =
      this.basePath +
      '/teams/members/{member_name}/teams'.replace(
        '{' + 'member_name' + '}',
  ...
  public async teamsTeamIdGet(
    teamId: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: TeamsResponseWithId }> {
    const localVarPath =
      this.basePath +
      '/teams/{team_id}'.replace(
        '{' + 'team_id' + '}',
  ...
  public async teamsTeamIdMembersNameRoleDelete(
    ...
    const localVarPath =
      this.basePath +
      '/teams/{team_id}/members/{name}/role'
        .replace('{' + 'team_id' + '}', encodeURIComponent(String(teamId)))
        .replace('{' + 'name' + '}', encodeURIComponent(String(name)));
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
  ...
  public async teamsTeamIdSitesGet(
    teamId: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: Array<SiteResponse> }> {
    const localVarPath =
      this.basePath +
      '/teams/{team_id}/sites'.replace(
        '{' + 'team_id' + '}',
  ...
  public async teamsTeamIdSitesSiteIdGet(
    ...
    siteId: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: SiteResponse }> {
    const localVarPath =
      this.basePath +
      '/teams/{team_id}/sites/{site_id}'
        .replace('{' + 'team_id' + '}', encodeURIComponent(String(teamId)))
