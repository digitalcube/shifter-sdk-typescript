...
import { UsageSummaryGetResponse } from '../model/usageSummaryGetResponse';
...
export class StatisticsApi {
     ...
     */
    public async statisticsUsageSummaryGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UsageSummaryGetResponse;  }> {
        const localVarPath = this.basePath + '/statistics/usage_summary';
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UsageSummaryGetResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UsageSummaryGetResponse");
