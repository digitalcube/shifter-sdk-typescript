...
export class SitesApi {
  ...
  public async sitesPost(
    ...
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: SiteCreateResponse }> {
    const localVarPath = this.basePath + '/sites';
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
  ...
  public async sitesSiteIdCdnPaygDelete(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/cdn/payg'.replace(
        '{' + 'site_id' + '}',
  ...
  public async sitesSiteIdGenerateHistoryGet(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/generate_history'.replace(
        '{' + 'site_id' + '}',
        encodeURIComponent(String(siteId))
      );
    let localVarQueryParameters: any = {};
  ...
  public async sitesSiteIdNotificationEmailDelete(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/notification/email'.replace(
        '{' + 'site_id' + '}',
        encodeURIComponent(String(siteId))
      );
    let localVarQueryParameters: any = {};
  ...
  public async sitesSiteIdPublicContentDelete(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/public_content'.replace(
        '{' + 'site_id' + '}',
        encodeURIComponent(String(siteId))
      );
    let localVarQueryParameters: any = {};
  ...
  public async sitesSiteIdShifterCdnTransferAmountGet(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/shifter_cdn_transfer_amount'.replace(
        '{' + 'site_id' + '}',
        encodeURIComponent(String(siteId))
      );
    let localVarQueryParameters: any = {};
    ...
    if (startMonth !== undefined) {
      localVarQueryParameters['start_month'] = ObjectSerializer.serialize(
        startMonth,
        'number'
      );
    }
    ...
    if (range !== undefined) {
      localVarQueryParameters['range'] = ObjectSerializer.serialize(
        range,
        'number'
      );
    }
  ...
  public async sitesSiteIdSubscriptionMigratePost(
    ...
    const localVarPath =
      this.basePath +
      '/sites/{site_id}/subscription/migrate'.replace(
        '{' + 'site_id' + '}',
        encodeURIComponent(String(siteId))
      );
    let localVarQueryParameters: any = {};
