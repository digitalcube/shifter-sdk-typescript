...
export class IntercomApi {
     ...
     * Get intercom hmac
     */
    public async intercomHmacGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/intercom/hmac';
